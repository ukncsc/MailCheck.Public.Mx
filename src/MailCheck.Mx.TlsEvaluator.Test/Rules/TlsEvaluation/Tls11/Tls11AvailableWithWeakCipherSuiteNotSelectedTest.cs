...
namespace MailCheck.Mx.TlsEvaluator.Test.Rules.TlsEvaluation.Tls11
{
    ...
    public class Tls11AvailableWithWeakCipherSuiteNotSelectedTest
    {
        ...
        public async Task TcpErrorsShouldResultInInconclusive(TlsError tlsError)
        {
            ...
            TlsTestResults connectionTestResults = TlsTestDataUtil.CreateMxHostTlsResults(TlsTestType.Tls11AvailableWithWeakCipherSuiteNotSelected,
                tlsConnectionResult);
        ...
        public async Task ErrorsShouldHaveErrorDescriptionInResult(TlsError tlsError, string description)
        {
            ...
            TlsTestResults connectionTestResults =
                TlsTestDataUtil.CreateMxHostTlsResults(TlsTestType.Tls11AvailableWithWeakCipherSuiteNotSelected, tlsConnectionResult);
        ...
        [Test]
        public async Task ExpectWarningMessageWhenTls11HasErrorAndTls12NoError()
        {
