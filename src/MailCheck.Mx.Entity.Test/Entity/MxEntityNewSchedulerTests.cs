...
{
    [TestFixture]
    public class MxEntityNewSchedulerTests
    {
        private MxEntityNewScheduler _mxEntity;
        ...
        private ILogger<MxEntityNewScheduler> _log;

        [SetUp]
        public void SetUp()
        {
            _dao = A.Fake<IMxEntityDao>();
            _log = A.Fake<ILogger<MxEntityNewScheduler>>();
            ...
            _mxEntity = new MxEntityNewScheduler(_dao, _mxEntityConfig, _dispatcher, _changeNotifiersComposite, _clock, _log);
        }
