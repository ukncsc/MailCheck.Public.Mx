...
using MailCheck.Mx.Entity.Seeding.DomainCreated;
using Microsoft.Extensions.CommandLineUtils;

namespace MailCheck.Mx.Entity
{
    public static class LocalEntryPoint
    {
        public static void Main(string[] args)
        {
            ...
            {
                CommandOption dmarcConnectionString = command.Option("-d", "DMARC Connection String", CommandOptionType.SingleValue);
                CommandOption queueUrl = command.Option("-q", "Queue Url", CommandOptionType.SingleValue);

                command.OnExecute(() =>
                {
                    ISeeder seeder = SeederFactory.Create(dmarcConnectionString.Value(), queueUrl.Value());
