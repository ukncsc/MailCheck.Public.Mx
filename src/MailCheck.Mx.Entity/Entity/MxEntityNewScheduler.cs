...
{
    public class MxEntityNewScheduler:
        ...
        IHandle<MxRecordsPolled>
    {
        ...
        private readonly ILogger<MxEntityNewScheduler> _log;
        private const string ServiceName = "Mx";

        public MxEntityNewScheduler(IMxEntityDao dao,
            IMxEntityConfig mxEntityConfig,
            IMessageDispatcher dispatcher, 
            IChangeNotifiersComposite changeNotifiersComposite, 
            IClock clock,
            ILogger<MxEntityNewScheduler> log)
        {
            _dao = dao;
            _log = log;
            _clock = clock;
